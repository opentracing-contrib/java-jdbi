...
public class OpentracingJdbi3PluginTest {
    ...
    public void testPluginToString() {
        MockTracer tracer = new MockTracer();
        assertEquals("OpentracingJdbi3Plugin{tracer=GlobalTracer{NoopTracer}}", new OpentracingJdbi3Plugin().toString());
        assertEquals("OpentracingJdbi3Plugin{tracer=" + tracer + "}", new OpentracingJdbi3Plugin(tracer).toString());
    }
}
